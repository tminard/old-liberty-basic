...
mapsx=17 'Map is this many frames on X
mapsy=17 'Map is this many frames on Y
'framekey$ = "" 'This is what the whole frame is based on
for framesec = 1 to 17
    ...
    for ymap = 1 to 17
        for xmap = 1 to 17
         ...
         print #main.graph, "addsprite ";framesec;"dirt";tile;" "+chosenText$
         print #main.graph, "spritexy ";framesec;"dirt";tile;" ";onx;" ";ony
         print #main.graph, "spritevisible ";framesec;"dirt";tile;" off"
         onx = onx + 30
        next xmap
    ony = ony + 30
    onx = 0
